...
type PaymentNotifyReq struct {
	NotifyTime     string `form:"notify_time,optional"`      // 通知时间
	NotifyType     string `form:"notify_type,optional"`      // 通知类型
	NotifyId       string `form:"notify_id,optional"`        // 通知ID
	AppId          string `form:"app_id"`                    // 应用ID
	Charset        string `form:"charset,optional"`          // 编码格式
	Version        string `form:"version,optional"`          // 接口版本
	...
	ReceiptAmount  string `form:"receipt_amount,optional"`   // 实收金额
	InvoiceAmount  string `form:"invoice_amount,optional"`   // 发票金额
	BuyerPayAmount string `form:"buyer_pay_amount,optional"` // 买家付款金额
	PointAmount    string `form:"point_amount,optional"`     // 积分支付金额
	FundBillList   string `form:"fund_bill_list,optional"`   // 支付渠道明细
	GmtCreate      string `form:"gmt_create,optional"`       // 交易创建时间
	GmtPayment     string `form:"gmt_payment,optional"`      // 交易付款时间
	Subject        string `form:"subject,optional"`          // 订单标题
	Body           string `form:"body,optional"`             // 订单描述
