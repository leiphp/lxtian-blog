...
type BookChapterDataSaveLogic struct {
	logx.Logger
	ctx    context.Context
...
// 章节数据保存
func NewBookChapterDataSaveLogic(ctx context.Context, svcCtx *svc.ServiceContext) *BookChapterDataSaveLogic {
	return &BookChapterDataSaveLogic{
...
func (l *BookChapterDataSaveLogic) BookChapterDataSave(req *types.BookChapterDataSaveReq) (resp *types.BookChapterDataSaveResp, err error) {
	...
	resp = new(types.BookChapterDataSaveResp)
	resp.Data = true
	return
}
