...
type (
	...
	DonateNotifyReq      = payment.DonateNotifyReq
	DonateNotifyResp     = payment.DonateNotifyResp
...
// 捐赠支付回调通知处理
func (m *defaultPayment) DonateNotify(ctx context.Context, in *DonateNotifyReq, opts ...grpc.CallOption) (*DonateNotifyResp, error) {
	client := payment.NewPaymentClient(m.cli.Conn())
	return client.DonateNotify(ctx, in, opts...)
}
