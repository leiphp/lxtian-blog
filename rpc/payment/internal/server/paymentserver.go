...
// 捐赠支付回调通知处理
func (s *PaymentServer) DonateNotify(ctx context.Context, in *payment.DonateNotifyReq) (*payment.DonateNotifyResp, error) {
	l := logic.NewDonateNotifyLogic(ctx, s.svcCtx)
	return l.DonateNotify(in)
}
