...
const (
	...
	Payment_DonateNotify_FullMethodName     = "/payment.Payment/DonateNotify"
...
type PaymentClient interface {
	...
	// 捐赠支付回调通知处理
	DonateNotify(ctx context.Context, in *DonateNotifyReq, opts ...grpc.CallOption) (*DonateNotifyResp, error)
	// 创建支付订单
...
func (c *paymentClient) Donate(ctx context.Context, in *DonateReq, opts ...grpc.CallOption) (*DonateResp, error) {
	...
	out := new(DonateResp)
	err := c.cc.Invoke(ctx, Payment_Donate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) DonateNotify(ctx context.Context, in *DonateNotifyReq, opts ...grpc.CallOption) (*DonateNotifyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DonateNotifyResp)
	err := c.cc.Invoke(ctx, Payment_DonateNotify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) RepayOrder(ctx context.Context, in *RepayOrderReq, opts ...grpc.CallOption) (*RepayOrderResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_RepayOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) PaymentHistory(ctx context.Context, in *PaymentHistoryReq, opts ...grpc.CallOption) (*PaymentHistoryResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_PaymentHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) OrdersStatistics(ctx context.Context, in *OrdersStatisticsReq, opts ...grpc.CallOption) (*OrdersStatisticsResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_OrdersStatistics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) GoodsList(ctx context.Context, in *GoodsListReq, opts ...grpc.CallOption) (*GoodsListResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_GoodsList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) Goods(ctx context.Context, in *GoodsReq, opts ...grpc.CallOption) (*GoodsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GoodsResp)
	err := c.cc.Invoke(ctx, Payment_Goods_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServer interface {
	...
	// 捐赠支付回调通知处理
	DonateNotify(context.Context, *DonateNotifyReq) (*DonateNotifyResp, error)
	// 创建支付订单
...
func (UnimplementedPaymentServer) DonateNotify(context.Context, *DonateNotifyReq) (*DonateNotifyResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DonateNotify not implemented")
}
...
func _Payment_DonateNotify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DonateNotifyReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServer).DonateNotify(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payment_DonateNotify_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).DonateNotify(ctx, req.(*DonateNotifyReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Payment_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DonateNotify",
			Handler:    _Payment_DonateNotify_Handler,
		},
		{
