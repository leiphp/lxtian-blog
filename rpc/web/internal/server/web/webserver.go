...
func (s *WebServer) OrderStat(ctx context.Context, in *web.OrderStatReq) (*web.OrderStatResp, error) {
	l := weblogic.NewOrderStatLogic(ctx, s.svcCtx)
	return l.OrderStat(in)
}
