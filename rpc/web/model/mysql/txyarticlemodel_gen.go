...
func (m *defaultTxyArticleModel) Insert(ctx context.Context, data *TxyArticle) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Title, data.Author, data.Content, data.Keywords, data.Path, data.Description, data.IsHot, data.IsTuijian, data.Status, data.IsDelete, data.IsTop, data.IsOriginal, data.ViewCount, data.Click, data.Ctime, data.Mtime, data.Cid, data.Tid)
	return ret, err
}
...
func (m *defaultTxyArticleModel) Update(ctx context.Context, data *TxyArticle) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.Title, data.Author, data.Content, data.Keywords, data.Path, data.Description, data.IsHot, data.IsTuijian, data.Status, data.IsDelete, data.IsTop, data.IsOriginal, data.ViewCount, data.Click, data.Ctime, data.Mtime, data.Cid, data.Tid, data.Id)
	return err
}
