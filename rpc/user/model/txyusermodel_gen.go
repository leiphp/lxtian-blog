...
func (m *defaultTxyUserModel) Update(ctx context.Context, newData *TxyUser) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, newData.Uid, newData.Type, newData.Nickname, newData.HeadImg, newData.Openid, newData.AccessToken, newData.SessionKey, newData.MiniappOpenid, newData.Unionid, newData.Ctime, newData.Mtime, newData.LastLoginTime, newData.LastLoginIp, newData.LoginTimes, newData.Status, newData.Email, newData.Username, newData.Password, newData.IsAdmin, newData.Gold, newData.Score, newData.Conscore, newData.Id)
	return err
}
